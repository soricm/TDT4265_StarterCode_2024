...
class ExampleModel(nn.Module):
    def __init__(self, image_channels, num_classes):
        ...
        """
        super().__init__()
        # Implement this function (Task  2a) 
        # to replicate the results of 2a, you should remove the data augmentations 
        # from the dataloader and change the trainer optimizer back to default
        ...
        for i in range(len(self.classifier)):
            if isinstance(self.classifier[i], nn.Conv2d):
